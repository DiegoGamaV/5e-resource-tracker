import * as tags from "../models/classAbilityTags";
...
const monkId = classController.addClass(
  "Monge",
  "Ponto de Ki",
  "Pontos de Ki",
  kiPointsProgression
...
classController.addClassAbility(
  ...
  undefined,
  2,
  [tags.COMBAT_TAG, tags.DAMAGE_TAG]
);
...
classController.addClassAbility(
  ...
  undefined,
  2,
  [tags.COMBAT_TAG, tags.DEFENSE_TAG, tags.BUFF_TAG]
);
...
classController.addClassAbility(
  ...
  undefined,
  2,
  [tags.COMBAT_TAG, tags.DEFENSE_TAG, tags.BUFF_TAG, tags.MOVEMENT_TAG]
);
...
classController.addClassAbility(
  ...
  undefined,
  14,
  [tags.COMBAT_TAG, tags.DEFENSE_TAG]
);
